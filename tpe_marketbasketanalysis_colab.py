...
# Mostrar la tipologia de cada Atributo de la DB
df.info()

# Aplicando Data QA corrigiendo Dtipo de fecha object por datetime
df['fecha'] = pd.to_datetime(df['fecha'])

# Mostrar tipologia corregida
df.info()

# Creando un mini DataFrame para optimizar recursos computacionales
